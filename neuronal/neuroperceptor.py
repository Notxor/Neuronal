...
class _Sensor(Neurona):
    """Elemento de entrada de un sentido."""
...
class NeuroPerceptor(object):
    ...
    def __init__(self, cantidad_de_sensores, red = None):
        ...
        cambian a lo largo de la vida del sentido.
        """
    ...
    def _conectar_a_red_receptora(self, red):
        ...
        haya en el sentido, mediante sinapsis sensor->neurona. Es conveniente
        que dichas neuronas sean las que inician la lista de neuronas del
        núcleo. El objetivo es que sean disparadas al inicio del 'ciclo' para
        reducir el número de pasadas que habrá que darle al núcleo.
        """
    ...
    def enviar_estimulos(self):
        """
        Envía todos los estimulos de la sensación actual en este sentido mediante las sinapsis que están conectadas a la red receptora.
        """
